...
from app.scrapers.indeed.constant import job_search_query, api_headers
from app.scrapers.indeed.util import is_job_remote, get_compensation, get_job_type
from app.scrapers.model import (
    Scraper,
    ScraperInput,
    Site,
    JobPost,
